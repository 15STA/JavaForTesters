...
public class UserInterface {
    ...
    public void runApplication() {
        ...
        while (true) {
            System.out.println("Введите название города на английском языке или exit (выход) для выхода из программы");
            ...
            System.out.println("Введите ответ: 1 - Получить текущую погоду, " +
                "2 - Получить погоду на следующие 5 дней, " + "3 - Вывести погоду из базы данных, " +
